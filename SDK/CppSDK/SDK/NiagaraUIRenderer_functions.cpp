...
void UNiagaraSystemWidget::SetColorAndOpacity(const struct FLinearColor& InColorAndOpacity)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NiagaraSystemWidget", "SetColorAndOpacity");

	Params::NiagaraSystemWidget_SetColorAndOpacity Parms{};
